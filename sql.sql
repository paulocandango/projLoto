...
,('Obituario AAFIT','https://site.aafit.org.br/obituario/','.year-header:first-of-type','#table-2024 tr:nth-of-type(2) td:first-of-type',NULL,1)
,('Block Chair','https://blockchair.com/bitcoin','div.flow-gap-md a[href*="/bitcoin/block"] span[data-best-block]','div.value-body.ff-mono.value-body--lg > p > span',NULL,1)
